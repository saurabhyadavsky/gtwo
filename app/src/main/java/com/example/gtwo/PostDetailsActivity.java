...
import com.example.gtwo.adapters.AdapterComment;
import com.example.gtwo.models.ModelComment;
        ...
        myref.orderByChild("uid").equalTo(myuid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1:dataSnapshot.getChildren()){
                    ...
                    try {
                        Picasso.get().load(mydp).into(imagep);
                    }
                    catch (Exception e){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot dataSnapshot1:dataSnapshot.getChildren()){
                  ...
                  uimage=dataSnapshot1.child("uimage").getValue().toString();
                    ...
                    try {
                        Picasso.get().load(hisdp).into(picture);
                    }
                    catch (Exception e){
