...
import com.example.gtwo.models.ModelUsers;
...
public class AddPostActivity extends AppCompatActivity {
    ...
    private void prepareNotification(String pId, String title, String description, String notificationType, String notificationTopic) throws JSONException {
        ...
        String notificationTopicUrl = "/topics/" + notificationTopic;
        String notificationTitle = title;
        String notificationMessage = description;
        String notificationTypeValue = notificationType;

        JSONObject notificationObject = new JSONObject();
        notificationObject.put("notificationType", notificationTypeValue);
        notificationObject.put("sender", uid);
        notificationObject.put("pId", pId);
        notificationObject.put("pTitle", notificationTitle);
        notificationObject.put("pDescription", notificationMessage);

        JSONObject object = new JSONObject();
        object.put("to", notificationTopicUrl);
    ...
    private void sendNotification(JSONObject notificationObject) {
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST,
                "https://fcm.googleapis.com/fcm/send", notificationObject,
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                headers.put("Authorization", "key=AAAAwgU4OoU:APA91bHUYVI5afqSOn0Fi0m-Z-xhzG_9mPyXxqL7h98RG19RiJzR7g0FpQjCQC5ChdHFDayfvXRMQX1LgQqsWbwVZPSpyAZxuFOxOm2lmTVd6SLKwtoasfCm4X-T-TrVpqFjsSYMt2Pu");
                return headers;
            }
        };
